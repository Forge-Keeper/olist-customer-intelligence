...
from olist_data_platform.common.logging.logger import LoggerFactory
...
def test_should_not_duplicate_handlers():
    ...
    first_logger = LoggerFactory.get_logger(
        logger_name
    )

    second_logger = LoggerFactory.get_logger(
        logger_name
    )
...
def test_should_reject_empty_logger_name(
    name,
):
    with pytest.raises(
        ValueError,
...
def test_should_reject_non_string_logger_name(
    name,
):
    with pytest.raises(
        TypeError,
