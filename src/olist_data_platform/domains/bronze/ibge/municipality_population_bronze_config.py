...
IBGE_MUNICIPALITY_POPULATION_BRONZE_CONFIG = DatasetContract(
    columns=(
        ColumnContract(
        ...
        ColumnContract(
            ...
            data_type="string",
            nullable=False,
            description="IBGE SIDRA variable code for the population measure.",
        ),
        ColumnContract(
            name="dt_base",
            data_type="date",
        ...
        ColumnContract(
            ...
            data_type="variant",
            nullable=False,
            description="Source SIDRA population payload preserved as VARIANT.",
        ),
        ColumnContract(
            name="request_id",
            data_type="string",
