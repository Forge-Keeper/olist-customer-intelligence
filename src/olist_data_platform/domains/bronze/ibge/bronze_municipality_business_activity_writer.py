...
from .municipality_business_activity_bronze_config import (
    IBGE_MUNICIPALITY_BUSINESS_ACTIVITY_BRONZE_CONFIG,
)


class BronzeMunicipalityBusinessActivityWriter:
    """Adapt IBGE SIDRA CEMPRE records to the Bronze table contract."""
    ...
    def __init__(self, spark: SparkSession, target_table: str) -> None:
        ...
        self.writer = BronzeWriter(
            ...
            config=IBGE_MUNICIPALITY_BUSINESS_ACTIVITY_BRONZE_CONFIG,
        )
